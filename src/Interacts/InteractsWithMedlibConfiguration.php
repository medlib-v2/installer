...
trait InteractsWithMedlibConfiguration
{
    /**
    ...
    protected function readToken()
    {
        if (! $this->configExists()) {
            throw new Exception("Medlib configuration file not found. Please register a token.");
        }
        return json_decode(
    ...
    {
        return $this->homePath().'/.medlib/config.json';
    }
